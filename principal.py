...
smtp_username = "jimfede@gmail.com" # This is the username used to login to your SMTP provider
smtp_password = "snosisuwwtikazvc" # This is the password used to login to your SMTP provider
...
smtp_sender = "jimfede@gmail.com" # This is the FROM email address
smtp_receivers = ['jimfede@gmail.com'] # This is the TO email address
...
message_dead = """From: Sensor de Humedad <sensor@humedad.com>
To: Federico Castrillon <jimfede@gmail.com>
Subject: Notificacion sensor de humedad
...
message_alive = """From: Sensor de Humedad <sensor@humedad.com>
To: Federico Castrillon <jimfede@gmail.com>
Subject: Notificacion sensor de humedad
...
def sendEmail(smtp_message):
    try:
        ...
        print "Error: no fue posible enviar el correo"
